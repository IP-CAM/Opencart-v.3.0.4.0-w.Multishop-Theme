...
$_['text_register_account']          = 'By creating an account you will be able to multishop faster, be up to date on an order\'s status, and keep track of the orders you have previously made.';
